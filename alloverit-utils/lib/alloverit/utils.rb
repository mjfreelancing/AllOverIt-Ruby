...
module AllOverIt
  module Utils
    ...
    # This method checks that an instance variable includes a specified module. The instance is returned
    ...
    # This method checks that an instance variable inherits a specified class. The instance is returned
