...
module AllOverIt
  module Utils
    ...
    # @return The original instance if its ancestor chain includes the specified class_type, otherwise an ArgumentError is raised.
    ...
    # @param instance [Object] The object to check if it inherits the specified class_type.
    # @param class_type [Class] The class type to check is a super class of the provided instance.
    # @return The original instance if it inherits the specified class_type, otherwise an ArgumentError is raised.
